...
<body>
    ...
    <img id="contact" src="../images/contactimg.png" alt=""></div>
                ...
                <form class="contact-form" name="form" action="clogin.php" onsubmit="return isvalid()" method="POST">
    <h1>LOGIN AS</h1>	

    <input type="hidden" name="user_type" value="candidate">
            <button id="join">Candidate</button><br>

    <label>Username</label>
    <input type="text" id="user" name="user" required><br>

    <label>Password</label>
    <input type="password" id="pass" name="pass" minlength="8" required><br><!-- min length added here-->
