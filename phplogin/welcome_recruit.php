  ...
  <body>
    ...
    <header>
      <div id="navbar" class="obj-width">
        ...
        <ul id="menu">
          <li><a href="#">Home</a></li>
          <li><a href="../contact_recruit.html">Contact Us</a></li>
    ...
    <section class="hero">
      <div class="hero-box obj-width">
        <div class="h-left">
            <h1 id="welcome"><?php echo "Welcome back, ".htmlspecialchars($username);?>!</h1>
          <h2>
    ...
    <section id="recruit" class="features sec-space obj-width">
      

           <h2 id="test">Post a Job Listing</h2>
          <a href="../joblisting.html">
            <pre></pre><h4 id="click">   Click here!</h4><pre></pre></a><br>
            <p id="recruit">
            Post your job openings on RecruitMate and connect with skilled candidates actively seeking opportunities. Our platform makes it quick and easy to list a position — just provide the job title, description, and requirements, and let us do the rest. Whether you're hiring for full-time, part-time, or remote roles, RecruitMate helps you reach the right talent faster and more efficiently.
              Search for jobs based on location, roles, skills and salary
              ranges.
            </p>
